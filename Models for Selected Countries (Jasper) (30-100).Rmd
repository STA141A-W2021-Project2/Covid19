---
title: "Models for Selected Countries (Jasper) (30-100)"
author: "Jasper Cheng"
date: "3/3/2021"
...
modegypt2=lm(egypt$CFR[30:100]~poly(egypt$Time[30:100],degree=2,raw=T))
modegypt3=lm(egypt$CFR[30:100]~poly(egypt$Time[30:100],degree=3,raw=T))

plot(egypt$Time[30:100],egypt$CFR[30:100])
lines(smooth.spline(egypt$Time[30:100],predict(modegypt2)),col='red')
lines(smooth.spline(egypt$Time[30:100],predict(modegypt3)),col='blue')
...
modjapan2=lm(japan$CFR[30:100]~poly(japan$Time[30:100],degree=3,raw=T))

plot(japan$Time[30:100],japan$CFR[30:100])
lines(smooth.spline(japan$Time[30:100],predict(modjapan2)),col='red')
...
modchina2=lm(china$CFR[30:100]~poly(china$Time[30:100],degree=3,raw=T))

plot(china$Time[30:100],china$CFR[30:100])
lines(smooth.spline(china$Time[30:100],predict(modchina2)),col='red')
...
brazil2= lm(brazildata$CFR[30:100]~poly(brazildata$time[30:100], degree=3, raw=T))
summary(brazil2)
plot(brazildata$time[30:100], brazildata$CFR[30:100])
lines(smooth.spline(brazildata$time[30:100],predict(brazil2)),col='blue')
...
india2= lm(indiadata$CFR[30:100]~poly(indiadata$time[30:100], degree=4, raw=T))
summary(india2)
plot(indiadata$time[30:100], indiadata$CFR[30:100])
lines(smooth.spline(indiadata$time[30:100],predict(india2)),col='blue')
...
indonesia2= lm(indonesiadata$CFR[30:100]~poly(indonesiadata$time[30:100], degree=2, raw=T))
summary(indonesia2)
plot(indonesiadata$time[30:100], indonesiadata$CFR[30:100])
lines(smooth.spline(indonesiadata$time[30:100],predict(indonesia2)),col='blue')
