...
```
# Abstract 
COVID-19 is a new coronavirus strain that emerged at the end of 2019. It is a highly infectious virus and there is currently no cure. Many countries have responded to this global pandemic by implementing preventative measures such as lockdowns, facial mask mandates and social distancing. The specifics such as timing and effectiveness of each country's response has varied widely. This report does a thorough analysis on how case fatality rate (CFR) varied over twelve different countries. Polynomial regression was fitted along with ANOVA modeling to analyze the data set. Sensitivity analysis confirmed correct model assumptions and fitting. Although there were limitations within this report, statistical analyses were able to conclude that there is a difference in CFR over time for different countries.
